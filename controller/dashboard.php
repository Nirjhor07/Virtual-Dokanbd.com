    ...
    if (isset($_SESSION['user_id'])) { // Check if user is logged in
        echo '<div class="dashboard" id="dashboard">
                  ...
                  <table class="dashboard-table">
                      ...
                      <tr>
                          <td><a class="dashboard-links" href="../view/UpdateUserInformation.php">Edit Profile</a></td>
                      </tr>
                      <tr>
                          <td><a class="dashboard-links" href="../view/showUserinfo.php">View Profile</a></td>
                      </tr>
                      <tr>
                          <td><a class="dashboard-links" href="changePassword.php">Change Password</a></td>
                      </tr>
                      <tr>
                          <td><a class="dashboard-links" href="../view/HomePage.php?activate_session=true">Home Page</a></td>
